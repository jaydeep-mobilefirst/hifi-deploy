...
export const ToolbarWhite = (props: any) => {
    const [burgerMenuOpen, setBurgerMenuOpen] = useState(false)
    const isDesktop = useMediaQuery('(min-width: 1025px)');
    const router = useRouter()

    if (isDesktop) {
        return <div className="ToolbarWhite">
                ...
                <div className="ButtonGroup Right">
                    <div className="LineBtn">
                        <div className="ButtonWrap dark">
                            <Link href="/"><button className="pBlue">Log In</button></Link>
                        </div>
                    </div>
                    <div className="AppBtn">
                        <button>
                        <Link target="blank" href="/signup">Get Started for Free</Link> 
                        </button>
                    </div>
                </div>
            </div>
        ...
        return <>
            <div className="ToolbarWhite">
                <div className="ToolbarInner">
                    <div className="AppName">
                        <Link href="/">
                            <Image src="../img/brand-logo.png" height="50" width="50" alt="Logo" />
                        </Link>
                    </div>
                    <div className="ToolbarMenu">
                        <div className="MenuHamburger">
                            <Button onClick={() => setBurgerMenuOpen(!burgerMenuOpen)}>
                                <Image src='./icons/menu-icon.svg' height="40" width="40" alt="Menu" />
                            </Button>
                        </div>
                    </div>

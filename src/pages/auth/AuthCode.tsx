      ...
      <div className="bg-image min-h-screen p-6 md:p-10 flex items-center justify-center">
        <div className="m-4 min-w-[300px] max-w-[452px] h-auto py-6 px-6 md:py-[50px] md:px-[59px] flex items-center justify-center flex-col rounded-2xl bg-[#F9F9F7] border-[#373389] border-[1px]">
          ...
          <div className="mt-[16px] md:mt-[40px]">
            <div className="text-poppins w-[280px] sm:w-[296px] text-center text-neutral-900 text-base font-normal leading-normal">
          ...
          <div className="mt-[16px] md:mt-[40px]">
            <div className="text-poppins cursor-pointer text-center text-violet-500 text-base font-normal underline">
              Use another authentication method.
            </div>
            <div className="mt-1 text-poppins text-center cursor-pointer text-violet-500 text-base font-normal underline">
